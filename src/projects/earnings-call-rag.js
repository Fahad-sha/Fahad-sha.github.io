// src/data/projects/earningsCallRag.js (or wherever your project objects live)
...
export const earningsCallRag = {
  ...
  subtitle:
    "Financial analysis tool for earnings transcripts using RAG + structured outputs",
  ...
  // Optional: add these if your UI uses them
  // featured: true,
  // date: "2026-01-10",
